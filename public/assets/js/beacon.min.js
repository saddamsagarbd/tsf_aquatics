    ...
    ! function() {
        ...
        function t(e, t) {
            ...
            var u = n.timing,
                ...
                v = y[2] || y[1] || y[0],
                h = {
                    abTestId: g ? g.abTestId : "",
                    memory: {},
                    timings: {},
                    resources: [],
                    tempResources: [],
                    referrer: R && B && T && v ? v.url : p,
                    ...
                    si: g ? g.si : 0,
                    startTime: n.timeOrigin || (u ? u.navigationStart : 0),
                    versions: {
                        fl: g ? g.version : "",
                        js: "2021.5.3",
                        timings: 1
            ...
            if (h.documentWriteIntervention = a(), h.firstPaint = o("first-paint"), h.firstContentfulPaint = o("first-contentful-paint"), h.errorCount = window.__cfErrCount || 0, b && (h.largestContentfulPaint = b.lcp && void 0 !== b.lcp.value ? b.lcp.value : -1, h.firstInputDelay = b.fid && void 0 !== b.fid.value ? b.fid.value : -1, h.cumulativeLayoutShift = b.cls && void 0 !== b.cls.value ? b.cls.value : -1), R && g && (h.siteToken = g.token, T = !0), "function" == typeof n.getEntriesByType) {
                ...
                E.forEach(function(e) {
                    var t = {
                        ...
                        i: e.initiatorType,
                        p: e.nextHopProtocol,
                        rs: c(e.redirectStart),
                        re: c(e.redirectEnd),
                        fs: c(e.fetchStart),
                        ds: c(e.domainLookupStart),
                        de: c(e.domainLookupEnd),
                        cs: c(e.connectStart),
                        ce: c(e.connectEnd),
                        qs: c(e.requestStart),
                        ps: c(e.responseStart),
                        pe: c(e.responseEnd),
                        ws: c(e.workerStart),
                        ss: c(e.secureConnectionStart),
                        ts: e.transferSize,
        ...
        if (!g || "single" !== g.load) {
            ...
            document.addEventListener("visibilitychange", function() {
                R && B && 0 === y.filter(function(e) {
                    return e.id === m
                }).length && k(), "hidden" === document.visibilityState && !S && T && (S = !0, A(B && R))
            });
            var b = {
                    lcp: void 0,
                    cls: void 0,
            ...
            if (n && g && (g.rayId || g.token)) {
                var I = R ? g.send && g.send.to ? g.send.to : void 0 === g.version ? "https://cloudflareinsights.com/cdn-cgi/rum" : null : null,
                    k = function(e) {
                        var n = function(e, t, n) {
                                i.resources = e, 0 != t && (i.bypassTiming = !0), g && (1 === g.r && (i.resources = []), R && B && 0 === t && (y.push({
                                    id: i.pageloadId,
                                    url: i.location
                                }), y.length > 3 && y.shift()), d.sendObjectBeacon(n, i, function() {}, !1, I), void 0 !== g.forward && void 0 !== g.forward.url && d.sendObjectBeacon(n, i, function() {}, !1, g.forward.url))
                            },
                            i = t(e);
                        if (i && g) {
                ...
                "complete" === window.document.readyState ? j() : window.addEventListener("load", function() {
                    window.setTimeout(j)
                }), B && R && (h = i(), function(e) {
                    var t = e.pushState;
                    if (t) {
                        var r = function() {
                            m = p(), "function" == typeof n.clearResourceTimings && n.clearResourceTimings()
                        };
                        e.pushState = function(n, o, a) {
                            return w = i(a), 0 === y.filter(function(e) {
                                return e.id === m
                            }).length && k(i()), r(), t.apply(e, [n, o, a])
    ...
    var i, r, o, a, c = function(e, t) {
        ...
        v = function(e, t) {
            var n, i = c("CLS", 0),
                ...
                o = s("layout-shift", r);
            o && (n = p(e, i, t), f(function() {
                o.takeRecords().map(r), n()
            }), d(function() {
                i = c("CLS", 0), n = p(e, i, t)
            }))
        },
        ...
        h = function(e, t) {
            var n, i = w(),
                ...
                o = s("paint", function(e) {
                    "first-contentful-paint" === e.name && (o && o.disconnect(), e.startTime < i.timeStamp && (r.value = e.startTime, r.entries.push(e), l.add(r), n()))
                });
            o && (n = p(e, r, t), d(function(i) {
                r = c("FCP"), n = p(e, r, t), requestAnimationFrame(function() {
                    requestAnimationFrame(function() {
                        r.value = performance.now() - i.timeStamp, l.add(r), n()
                    })
                })
            }))
        },
        ...
        T = new Date,
        b = function(e, t) {
            i || (i = t, r = e, o = new Date, L(removeEventListener), E())
        },
        E = function() {
            if (r >= 0 && r < o - T) {
                var e = {
        ...
        C = function(e, t) {
            var n, o = w(),
                u = c("FID"),
                v = function(e) {
                    e.startTime < o.timeStamp && (u.value = e.processingStart - e.startTime, u.entries.push(e), l.add(u), n())
                },
                m = s("first-input", v);
            n = p(e, u, t), m && f(function() {
                m.takeRecords().map(v), m.disconnect()
            }, !0), m && d(function() {
                var o;
        ...
        P = function(e, t) {
            ...
            if (a) {
                n = p(e, r, t);
                var u = function() {
                    l.has(r) || (a.takeRecords().map(o), a.disconnect(), l.add(r), n())
                };
                ["keydown", "click"].forEach(function(e) {
                    ...
                    r = c("LCP"), n = p(e, r, t), requestAnimationFrame(function() {
                        requestAnimationFrame(function() {
                            r.value = performance.now() - i.timeStamp, l.add(r), n()
                        })
                    })
