					...
					<div class="product-details"><!--product-details-->
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active">
										  <a href=""><img src="{{URL::to($product_manage->product_image)}}" width="70" height="35" alt=""></a>
										</div>										
									</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<h2>{{$product_manage->product_name}}</h2>
