...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{asset('admin_css/vendor/datatables/dataTables.bootstrap4.css')}}" rel="stylesheet">
    ...
    <!-- <link href="{{asset('admin_css/images/favico/favico.png')}}" rel="shortcut icon"> -->
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="{{URL::to('/dashboard')}}">Start Bootstrap</a>
