                    ...
                    <form id="product_form" enctype="multipart/form-data" action="{{ url('/save-product') }}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="product_name" name="product_name" required="required" value="{{$edit_product->product_name}}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        	<select name="product_brand" id="product_brand" class="form-control col-md-7 col-sm-7 col-xs-12">
                        		<option value="{{$edit_product->manufacture_id}}">{{$edit_product->manufacture_name}}</option>
                        		<?php
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea required="required" id="short_description" name="short_description" class="form-control col-md-7 col-xs-12" maxlength="80">{{$edit_product->short_description}}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea required="required" id="long_description" name="long_description" class="form-control col-md-7 col-xs-12" maxlength="250">{{$edit_product->long_description}}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="product_price" name="product_price" required="required" value="{{$edit_product->product_price}}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="product_qty" name="product_qty" required="required" value="{{$edit_product->product_qty}}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="product_color" value="{{$edit_product->product_color}}" name="product_color" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="product_size" name="product_size" required="required" value="{{$edit_product->product_size}}" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        	<select name="publication_status" id="publication_status" class="form-control col-md-7 col-sm-7 col-xs-12">
                        		<option value="{{$edit_product->publication_status}}">
                        			@if($edit_product->publication_status == 1)
                        			Published
                        			@else
                        			Unpublished
                        			@endif
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a class="btn btn-primary" href="{{url('/all-product')}}">Cancel</a>
